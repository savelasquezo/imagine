...
const CreatePackageModal: React.FC<SessionModal> = ({ closeModal, session  }) => {
    ...
    return (
        <div className='w-full h-full'>
            <form method="POST" onSubmit={(e) => onSubmit(e)} className="relative flex flex-col w-full h-full text-center gap-y-2">
